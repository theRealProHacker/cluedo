...
- **Balance note:** the default gives the first player (the starter) the smaller hand;
  the manual control adds transparency and lets you match your group's actual deal
